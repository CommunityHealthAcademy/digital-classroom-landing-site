      ...
      >
        ...
        <Section role="contentinfo" aria-label="Our Mission">
          ...
          <SectionText>
            ...
            high-quality healthcare is a universal human right. And now, with
            the current global crisis, populations around the world need rapid,
            coordinated, and focused support to tackle the COVID-19 pandemic.
            Patients in countries with limited preparedness and response
            resources are particularly vulnerable to COVID-19, and sharp
            increases in COVID-19 caseloads are likely to overwhelm health
            systems in countries already facing shortages of nurses, physicians,
          ...
          <SectionText>
            ...
            communities, wherever in the world they are providing care, from
            city centers to the last mile.
          </SectionText>
        </Section>
      </Layout>
    </ThemeProvider>
